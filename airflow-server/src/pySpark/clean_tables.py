...
def clean_data_tables():
    ...
    # disease_death_year = disease_death_renamed.groupBy(['name', 'year']).agg(sum('val').alias('disease_death_val'))
    ...
    yearly_surface_temp_full.printSchema()
    yearly_surface_temp_full.show(5)
