...
def aggregate_data_tables():
    ...
    energy_consumption = spark.read.csv(f"gs://{bucket}/energy_consumption/", header=True, inferSchema=True)
    average_precipitation = spark.read.csv(f"gs://{bucket}/average_precipitation/", header=True, inferSchema=True)
    gdp_ppp_per_capita = spark.read.csv(f"gs://{bucket}/gdp_ppp_per_capita/", header=True, inferSchema=True)
    gdp_nominal_per_capita = spark.read.csv(f"gs://{bucket}/gdp_nominal_per_capita/", header=True, inferSchema=True)
    inflation_rate = spark.read.csv(f"gs://{bucket}/inflation_rate/", header=True, inferSchema=True)
    crime_rate = spark.read.csv(f"gs://{bucket}/crime_rate/", header=True, inferSchema=True)
    intl_tourist_spending = spark.read.csv(f"gs://{bucket}/intl_tourist_spending/", header=True, inferSchema=True)
    natural_disaster_death = spark.read.csv(f"gs://{bucket}/natural_disaster_death/", header=True, inferSchema=True)
    international_tourist_trips = spark.read.csv(f"gs://{bucket}/international_tourist_trips/", header=True, inferSchema=True)

    disease_death = spark.read.csv(f"gs://{bucket}/disease_death/", header=True, inferSchema=True)
    ...
    internet_penetration = spark.read.csv(f"gs://{bucket}/internet_penetration_rate/", header=True, inferSchema=True)
    internet_penetration = internet_penetration\
        .withColumnRenamed('it_net_user_zs', 'internet_user_score')\
    
    # Monthly surface temp data
    average_monthly_surface_temp_full = spark.read.csv(f"gs://{bucket}/average_monthly_surface_temp/", header=True, inferSchema=True)
    ...
    world_heritage_sites = spark.read.csv(f"gs://{bucket}/unesco_whs_by_country/", header=True, inferSchema=True)
    ...
    infrastructure_raw = spark.read.csv(f"gs://{bucket}/infrastructure/", header=True, inferSchema=True)
